...
import static com.megster.cordova.BluetoothSerialService.NAME_SECURE;

import static org.apache.cordova.device.Device.uuid;
...
public class BluetoothSerial extends CordovaPlugin {
  ...
  public void listen(final JSONArray args, final String address, final CallbackContext callbackContext) {
      ...
      try {
          serverSocket = adapter.listenUsingRfcommWithServiceRecord("BluetoothSerial", uuid);
      } catch (final IOException e) {
          callbackContext.error(e.getMessage());
          return;
      }
      final CordovaArgs args = new CordovaArgs(args.getString(0));
      final Boolean secure = args.getBoolean(0);

      final ConnectThread connectThread = new ConnectThread(serverSocket, secure, callbackContext);
      connectThread.start();
  }
